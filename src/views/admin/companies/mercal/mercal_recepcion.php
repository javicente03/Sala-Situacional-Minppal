                ...
                <div class="col col-xl-12 order-xl-2 col-lg-12 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
                    <div class="ui-block">
                        <div class="ui-block-title">
                            <h6 class="title">Registrar nueva recepción</h6>
                        </div>
                        <div class="ui-block-content">
                            <form id='form' data-url="/admin/mercal/in" data-method="post" data-action="fixed" data-redirect="/admin/clap">
