            ...
            <div class="row">
                ...
                <div class="col col-xl-12 order-xl-2 col-lg-12 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
                    <div class="ui-block ui-block-title ui-block-title-small containerFilters">
                        ...
                        <a href="/admin/clap/create" class="btn btn-primary btn-lg-2 btn-sm-2">
                                ...
                                ?>
                                    <tr class="event-item">
                                        ...
                                        <td class="add-event td-actions">
                                            <a href="/admin/clap/custom/<?php echo $clap['id_clap_por_entrega'] ?>" class="btn btn-primary btn-sm" title="Customizar entrega" target="_blank">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="/admin/clap/load/<?php echo $clap['id_clap_por_entrega'] ?>" class="btn btn-primary btn-sm" title="Subir entrega" target="_blank">
