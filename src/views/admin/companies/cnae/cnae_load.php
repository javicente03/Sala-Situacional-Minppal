        ...
        <div class="col col-xl-9 order-xl-2 col-lg-9 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
            <div class="ui-block">
                ...
                <div class="ui-block-content">
                    ...
                    <form id='form' data-url="/admin/cnae/load" data-method="post" data-action="fixed" data-redirect="/admin/cnae">
                        ...
                        <div class="row">
                            <div class="col col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="form-group label-floating is-select">
                                    ...
                                    <select class="form-select" id="municipio" name="municipio">
                                        ...
                                        ?>
                                            <option value="<?php echo $municipio['id_cnae_por_municipio']; ?>"><?php echo $municipio['name_municipio']; ?></option>
                                        <?php
                                            }
                                        ?>
                            ...
                            <div class="col col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" placeholder="" type="number" id="instituciones"
                                    name="instituciones" min="0">
                                </div>
                            </div>
                            ...
                            <div class="col col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" placeholder="" type="number" id="matricula"
                                    name="matricula" min="0">
                                </div>
                            </div>
